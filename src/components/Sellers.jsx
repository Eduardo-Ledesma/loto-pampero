    ...
    return (
        <>
            <tr className="border-b last-of-type:border-0">
                ...
                <button
                        type="button"
                        className="bg-green-600 hover:bg-green-700 transition-colors px-4 py-2 rounded-lg uppercase 
                        font-bold text-2xl sm:text-3xl mb-4 lg:mb-0 flex items-center w-full gap-1 md:w-full lg:w-auto"
                    ...
                    <button
                        ...
                        text-2xl sm:text-3xl flex items-center w-full lg:w-auto gap-1`}
                        onClick={handleClick}
                    >
                        {windowWidth < 500 ? (
