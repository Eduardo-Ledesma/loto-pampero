            ...
            <form className={stylesForm.form}>
                <legend className={stylesForm.form_legend}>Introduce tu nueva contraseña</legend>
                    <div className='flex justify-center my-12'>
                        <input className={stylesForm.input_reset} type="password" name="password" id="password" placeholder="Contraseña Nueva"/>
                    </div>
                    <div className='flex justify-center'>
                        <input className={stylesForm.input_reset} type="password" name="password" id="password" placeholder="Repite la Contraseña"/>
                    </div>
